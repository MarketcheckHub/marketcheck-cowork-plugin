...
dimension key (`body_type` or `fuel_type_category` or `make` or `model`) and
emits per-row cross-period diffs with classifications.

Classifications (per `references/tier-and-verdict-bands.md`):
