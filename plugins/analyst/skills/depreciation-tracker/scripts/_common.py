...
def _maybe_unwrap(raw: str) -> Any:
    ...
    `parse_sold_summary.py` needs no special-case. The other tools this skill
    might call (only `search_active_cars` on the facet-discovery recovery
    path) arrive envelope-wrapped. See `references/sold-summary-safety.md`
