...
Show: year/make/model/trim, VIN, mileage, location name + ZIP, predicted market value, MSRP + retention %, market context (competing units, price range, avg asking, lowest competitor), top 3-5 comparables, verdict (priced RIGHT / ABOVE / BELOW market by $X). If user has asking price, give specific recommendation.
