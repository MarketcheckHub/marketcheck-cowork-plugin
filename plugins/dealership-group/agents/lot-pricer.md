...
<example>
Context: Weekly review pricing a location's full lot
user: "Run my weekly review"
assistant: "I'll use the lot-pricer agent to price all 85 units on this location's lot against the market and classify each one."
<commentary>
...
user: "Daily briefing"
assistant: "I'll use the lot-pricer agent to price the 12 units over 60 days at this location."
<commentary>
