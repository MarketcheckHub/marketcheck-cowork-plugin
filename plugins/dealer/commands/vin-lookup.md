...
Show: vehicle specs (year/make/model/trim/body/engine/transmission/fuel/MSRP), listing history table (date/dealer/price/status/DOM), total market exposure, price journey, estimated value at 50K miles (note: provide actual mileage for accuracy), top 3-5 comparables. If no history: note vehicle may not have been listed recently.
