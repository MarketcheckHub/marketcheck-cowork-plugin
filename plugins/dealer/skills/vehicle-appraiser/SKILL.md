...
The primary user is a **dealer trade-in desk manager** who needs a quick but credible number to present to a customer sitting across the desk. The secondary user is a **dealer GM or used car manager** who needs a defensible valuation backed by specific comparable vehicles and transaction data.
