...
4. Confirm: "Benchmarking **[N]** locations for **[group_name]**"
...
- **Aged %** = units_over_60 / total × 100
- **Fresh %** = units_under_30 / total × 100 (recently acquired)
- **Avg listing price**
...
- **Overpriced %** = units with gap > +5% / sampled units × 100
- **Underpriced %** = units with gap < -5% / sampled units × 100
